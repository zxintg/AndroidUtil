...
import com.zxin.ncalendar.adapter.WeekAdapter;
import com.zxin.ncalendar.listener.OnClickWeekViewListener;
import com.zxin.ncalendar.listener.OnWeekCalendarChangedListener;
...
import com.zxin.ncalendar.view.WeekView;
...
public class WeekCalendar extends CalendarPager implements OnClickWeekViewListener {
    ...
    protected CalendarAdapter getCalendarAdapter() {
        ...
        mPageSize = CalendarUtils.getIntervalWeek(startDate, endDate, CalendarAttrs.firstDayOfWeek) + 1;
        mCurrPage = CalendarUtils.getIntervalWeek(startDate, mInitialDate, CalendarAttrs.firstDayOfWeek);
    ...
    protected void setDate(LocalDate date) {
        ...
        if (!currectWeekView.contains(date)) {
            ...
            int weeks = CalendarUtils.getIntervalWeek(initialDate, date, CalendarAttrs.firstDayOfWeek);
