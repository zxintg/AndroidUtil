...
public class ShopComboFragment extends BaseFragment implements BaseFragment.LazyLoadingListener,MainDiscoveryContract.ShopComboView {
    private String scId;
    private String name;
    ...
    public static ShopComboFragment newInstance(String scId,String name,String cityId) {
        ShopComboFragment fragment = new ShopComboFragment();
    ...
    public void initData() {
        ...
        presenter.initShopComboDatas(this,scId,name,cityId);
