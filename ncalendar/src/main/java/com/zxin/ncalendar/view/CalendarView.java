package com.zxin.ncalendar.view;
...
public abstract class CalendarView extends View {
    ...
    public CalendarView(Context context) {
        super(context);
        mSolarTextColor = CalendarAttrs.solarTextColor;
        mLunarTextColor = CalendarAttrs.lunarTextColor;
        mHintColor = CalendarAttrs.hintColor;
        mSolarTextSize = CalendarAttrs.solarTextSize;
        mLunarTextSize = CalendarAttrs.lunarTextSize;
        mSelectCircleRadius = CalendarAttrs.selectCircleRadius;
        mSelectCircleColor = CalendarAttrs.selectCircleColor;
        isShowLunar = CalendarAttrs.isShowLunar;

        mPointSize = CalendarAttrs.pointSize;
        mPointColor = CalendarAttrs.pointColor;
        mHollowCircleColor = CalendarAttrs.hollowCircleColor;
        mHollowCircleStroke = CalendarAttrs.hollowCircleStroke;

        isShowHoliday = CalendarAttrs.isShowHoliday;
        mHolidayColor = CalendarAttrs.holidayColor;
        mWorkdayColor = CalendarAttrs.workdayColor;

        mRectList = new ArrayList<>();
        mSorlarPaint = getPaint(mSolarTextColor, mSolarTextSize);
        mLunarPaint = getPaint(mLunarTextColor, mLunarTextSize);

        holidayList = CalendarUtils.getHolidayList(getContext());
        workdayList = CalendarUtils.getWorkdayList(getContext());
    }
