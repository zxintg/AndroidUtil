...
public class MarryPayOrderActivity extends BaseActivity {
    ...
    private void initView() {
        mTitleTab = getViewById(R.id.pst_payorder_title);
        mViewPager = getViewById(R.id.vp_payorder_fragment);
    }

    private void setView() {
        setTitleViewOnclick(R.id.ccb_marray_title,R.id.common_bar_leftBtn);
        titleList.addAll(TitleBarUtil.newInstance().getPayOrderList());
