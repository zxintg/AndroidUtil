...
public class StringUtils extends BaseStringUtils {
    ...
    public static String getUrl() {
        if (textIsEmpty(URL)) {
            URL = SystemInfoUtil.getAppMetaData("URL");
        }
        return URL;
    }
    ...
    public static String getADVERT_URL() {
        if (textIsEmpty(ADVERT_URL)) {
            ADVERT_URL = SystemInfoUtil.getAppMetaData("ADVERT_URL");
        }
        return ADVERT_URL;
    }
    ...
    public static String getXG_V2_ACCESS_ID() {
        if (textIsEmpty(XG_V2_ACCESS_ID)) {
            XG_V2_ACCESS_ID = SystemInfoUtil.getAppMetaData("XG_V2_ACCESS_ID");
        }
    ...
    public static String getXG_V2_ACCESS_KEY() {
        if (textIsEmpty(XG_V2_ACCESS_KEY)) {
            XG_V2_ACCESS_KEY = SystemInfoUtil.getAppMetaData("XG_V2_ACCESS_KEY");
        }
    ...
    public static String getTD_APP_ID() {
        if (textIsEmpty(TD_APP_ID)) {
            TD_APP_ID = SystemInfoUtil.getAppMetaData("TD_APP_ID");
        }
        return TD_APP_ID;
    }
    ...
    public static String getTD_CHANNEL_ID() {
        if (textIsEmpty(TD_CHANNEL_ID)) {
            TD_CHANNEL_ID = SystemInfoUtil.getAppMetaData("TD_CHANNEL_ID");
        }
    ...
    public static String getTC_SDKAPPID() {
        if (textIsEmpty(TC_SDKAPPID)) {
            TC_SDKAPPID = SystemInfoUtil.getAppMetaData("TC_SDKAPPID");
        }
        return TC_SDKAPPID;
    }
    ...
    public static String getTC_ACCOUNT_TYPE() {
        if (textIsEmpty(TC_ACCOUNT_TYPE)) {
            TC_ACCOUNT_TYPE = SystemInfoUtil.getAppMetaData("TC_ACCOUNT_TYPE");
        }
    ...
    public static String getH5_UU() {
        if (textIsEmpty(H5_UU)) {
            H5_UU = SystemInfoUtil.getAppMetaData("H5_UU");
        }
        return H5_UU;
    }
    ...
    public static String getH5_UU_REVIEWED() {
        if (textIsEmpty(H5_UU_REVIEWED)) {
            H5_UU_REVIEWED = SystemInfoUtil.getAppMetaData("H5_UU_REVIEWED");
        }
