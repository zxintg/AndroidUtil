...
public class RouterConsts {
    ...
    public static final String ROUTE_ANNOTATION_TYPE = "com.zxin.router.annotation.Route";
    public static final String INTERCEPTOR_ANNOTATION_TYPE = "com.zxin.router.annotation.Interceptor";
    public static final String PARAM_ANNOTATION_TYPE = "com.zxin.router.annotation.InjectParam";

    public static final String PACKAGE_NAME = "com.zxin.router";
