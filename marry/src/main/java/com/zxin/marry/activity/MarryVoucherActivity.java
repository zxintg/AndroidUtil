...
/**
 * Created by 优惠券 on 2018/6/13.
 */

public class MarryVoucherActivity extends BaseActivity {
    ...
    private void initView() {
        mTitleTab = getViewById(R.id.pst_voucher_title);
        mViewPager = getViewById(R.id.vp_voucher_fragment);
    }

    private void setView() {
        setTitleViewOnclick(R.id.ccb_marray_title,R.id.common_bar_leftBtn);
        titleList.addAll(TitleBarUtil.newInstance().getVoucherList());
    ...
    public int setLayout() {
        return R.layout.activity_voucher_order;
    }
