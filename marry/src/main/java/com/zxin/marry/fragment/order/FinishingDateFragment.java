...
public class FinishingDateFragment extends BaseFragment  implements BaseFragment.LazyLoadingListener ,OrderContract.FinishingDateView {
    private FirstOrderBean.SevenEntity sevenEntity;

    @InjectPresenter
    OrderPresenter presenter;

    public static Fragment newInstance(FirstOrderBean.SevenEntity datas) {
        FinishingDateFragment fragment = new FinishingDateFragment();
    ...
    public void initData() {
        sevenEntity = getArguments().getParcelable(StringUtils.FRAGMENT_DATA);
        presenter.initFinishingDate(this,sevenEntity);
        setLazyLoadingListener(this);
    }

    @Override
    public int setLayout() {
        return R.layout.finishing_activity;
    }
    ...
    public void loadLazyDatas(boolean bool) {
        presenter.getFinishingDate(sevenEntity.getOrderid(),sevenEntity.getShopid());
    }
    @Override
