...
public class WeekView extends CalendarView {
    ...
    public WeekView(Context context, LocalDate date, OnClickWeekViewListener onClickWeekViewListener) {
        ...
        CalendarUtils.NCalendar weekCalendar2 = CalendarUtils.getWeekCalendar2(date, CalendarAttrs.firstDayOfWeek);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mHeight = (int) (getHeight() - CalendarUtils.dp2px(getContext(), 2));
        mRectList.clear();
