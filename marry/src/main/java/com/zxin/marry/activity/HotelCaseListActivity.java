...
public class HotelCaseListActivity extends BaseActivity implements HotleContract.CaseListView{
    ...
    public void initData() {
        ...
        presenter.initHotelMoreCaseDatas(this,hotelid);
        setTitleViewOnclick(R.id.ccb_marray_title, R.id.common_bar_leftBtn);
    }

    @Override
    public int setLayout() {
        return R.layout.ac_hotel_caselist;
    }
