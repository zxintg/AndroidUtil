...
public class BanquetHallActivity extends BaseActivity implements HotleContract.BanquetHallView {
    ...
    public void initData() {
        ...
        presenter.initBanquetMoreHallDatas(this,hotelid);
        setTitleViewOnclick(R.id.ccb_marray_title, R.id.common_bar_leftBtn);
    }

    @Override
    public int setLayout() {
        return R.layout.ac_banquet_hall_list;
    }
