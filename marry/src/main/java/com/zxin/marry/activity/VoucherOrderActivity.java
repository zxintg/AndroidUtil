...
public class VoucherOrderActivity extends BaseActivity {
    ...
    private void initView() {
        mTitleTab = getViewById(R.id.pst_voucherorder_title);
        mViewPager = getViewById(R.id.vp_voucherorder_fragment);
    }

    private void setView() {
        setTitleViewOnclick(R.id.ccb_marray_title,R.id.common_bar_leftBtn);
        titleList.addAll(TitleBarUtil.newInstance().getVoucherOrderList());
    ...
    public int setLayout() {
        return R.layout.activity_voucherorder;
    }
