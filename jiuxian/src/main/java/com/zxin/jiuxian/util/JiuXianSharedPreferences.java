...
public class JiuXianSharedPreferences extends SharedPreferencesManager {
    private static SharedPreferences sp;

    static {
        sp = BaseApplication.getInstance().getContext().getSharedPreferences(BaseStringUtils.JiuXian_Datas, Context.MODE_PRIVATE);
    }
