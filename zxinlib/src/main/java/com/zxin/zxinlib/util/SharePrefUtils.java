...
public class SharePrefUtils {
    ...
    public static void put(String key, Object object) {
        SharedPreferences sp = BaseApplication.getInstance().getContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
    ...
    public static void remove(String key) {
        SharedPreferences sp = BaseApplication.getInstance().getContext().getSharedPreferences(FILE_NAME,
